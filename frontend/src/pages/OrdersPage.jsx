...
export default function OrdersPage() {
  ...
  // Bulk action stub: reorder
  const handleBulkReorder = () => {
    const ids = Object.entries(selectedIds)
      .filter(([_, sel]) => sel)
      .map(([id]) => id);
    if (!ids.length) return toast.info("No orders selected");
    toast.success(`Reorder request for ${ids.length} order(s) placed!`);
    setSelectedIds({});
  };
  ...
  if (!orders.length)
    return <p style={{ padding: "2rem" }}>You haven’t placed any orders yet.</p>;
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.filters}>
        ...
        <button onClick={handleBulkReorder} style={styles.bulkBtn}>
          Reorder Selected
        </button>
      </div>
        ...
        <thead>
          <tr>
            ...
            {[
              ...
              <th key={col} onClick={() => toggleSort(col)} style={styles.th}>
            ...
            return (
              <React.Fragment key={o.id}>
                ...
                >
                  ...
                  <td style={styles.td}>{o.seller_email}</td>
                  <td style={styles.td}>
